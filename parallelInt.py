...
NODE_SCHEMA = {
    ...
    "ForNode":         {"write_attr":  "var_name", "recurse_attr": ["iterable", "body"]},
    ...
    def gen(ast, shared_globals: dict = None, verbose: bool = True) -> str:
        ...
        for stage_num, indices in groups.items():
            ...
            if n_threads == 1:
                ...
                for t in threads: t.join()  # barrier — next stage waits for all
