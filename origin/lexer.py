...
TOKEN_REGEX = [
    ...
    (r"\b(none|if|elif|else|for|to|while|write|pi|with|return|py|int|read|len|str|sqrt|float|let|rand_num|const|in|graph|print|true|exec|false|abs|address|accel|gyro|temp|break|input|continue|def|func|import|from|class|try|call|except|set|ifinstance|pass|as|bool|parallel|range|self)\b", "KEYWORD"), # Reserved keywords
