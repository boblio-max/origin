...
TOKEN_REGEX = [
    ...
    (r"\[|\]|\{|\}",         "BRACKET"),
    (r"\(|\)|:|,|\.|;|\?",   "SYMBOL"),
    (r"\b(fn|if|elif|else|for|while|return|int|str|float|let|const|in|print|break|input|continue|import|from|class|try|except|raise|pass|yield|lambda|with|as|del|assert|global|nonlocal|async|await|match|case|macro|inline|parallel|when|unless|loop|until|do|struct|enum|type|interface|pub|priv)\b", "KEYWORD"),
